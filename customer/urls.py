...
urlpatterns = [
    ...
    path('check-eligibility', CheckEligibiltyView.as_view(),name="check_eligibility"),
    path('create-loan', CreateLoanView.as_view() , name="create_loan"),
    path('view-loan/<int:loan_id>',ViewLoanDetails.as_view(), name="view_loan"),
    path('view-loans/<int:customer_id>',ViewCustomerLoans.as_view(),name="view_loans")
]
